...
| [rust-design-idioms](software-engineering/rust-design-idioms/SKILL.md) | Rust design idioms: newtypes, typestate, state enums, RAII guards, capability tokens, sealed/extension traits, actor ownership, error design |
