...
Launch 8 subagents in parallel to review the implementation of plan <X>. Eight independent perspectives, no cross-talk, no shared context beyond the plan and the change scope.

Rules:
- Dispatch all 8 subagents in a single message. Parallel, not sequential.
- Each subagent receives: (1) the plan path <X>, (2) its output path <Y>-implementation-review-NN.md where NN comes from the table below, (3) the contents of its prompt file with the placeholder lines at the bottom filled in (<X>, <Y>, <Z>, and any extra fill from the table) — nothing else. No summary of prior conversation, no hints, no framing.
...
| 02 | /home/cristi/Projects/agent-skills/prompts/code-implementation-review/single-language/implementation-review-react-aggressive.md | — |
| 03 | /home/cristi/Projects/agent-skills/prompts/code-implementation-review/single-language/implementation-review-api-seam.md | <BACKEND> = Rust |
| 04 | /home/cristi/Projects/agent-skills/prompts/code-implementation-review/lenses/implementation-review-divergence.md | — |
...
Dispatch ONE fresh subagent — do not do this work yourself — with exactly this brief:
    ...
    Read the review files <Y>-implementation-review-01.md through <Y>-implementation-review-08.md. They are 8 independent reviews of the implementation of plan <X>. Write a synthesis to <Y>-implementation-review-synthesis.md:
