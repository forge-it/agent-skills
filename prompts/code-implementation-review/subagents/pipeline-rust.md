...
Launch 6 subagents in parallel to review the implementation of plan <X>. Six independent perspectives, no cross-talk, no shared context beyond the plan and the change scope.
...
Dispatch ONE fresh subagent — do not do this work yourself — with exactly this brief:
    ...
    Read the review files <Y>-implementation-review-01.md through <Y>-implementation-review-06.md. They are 6 independent reviews of the implementation of plan <X>. Write a synthesis to <Y>-implementation-review-synthesis.md:
