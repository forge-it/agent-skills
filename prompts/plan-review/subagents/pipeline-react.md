...
Launch 5 subagents in parallel to review plan <X>. Five independent perspectives, no cross-talk, no shared context beyond the plan itself.
...
Dispatch ONE fresh subagent — do not do this work yourself — with exactly this brief:
    ...
    Read the review files <Y>-plan-review-01.md through <Y>-plan-review-05.md. They are 5 independent reviews of plan <X>. Write a synthesis to <Y>-plan-review-synthesis.md:
